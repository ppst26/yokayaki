...
> 📋 **สถานะอัปเดต (2026-07-07):** Phase 1-5 พัฒนาเสร็จสมบูรณ์แล้ว — ดูรายละเอียดที่ [ROADMAP.md](file:///c:/Users/PP/Desktop/React/yokayaki/ROADMAP.md)
...
2026-07-23
2026-07-25
Environment & Full Database Migrations
PIN Auth & Table Map Switcher
POS Staff Order Screen & Stock Deduct
Staff Void Flow & Log Audit
Table Dynamic QR & Client Order Portal
Happy Hour Price Locks & Promos
Loyalty Member Registration & Point System
Checkout & Dynamic PromptPay QR
Owner Reports & EOD Sales Audit
Phase 1: DB & Auth
Phase 2: Ordering
Phase 3: QR Sessions
Phase 4: Business Logic
Phase 5: Payment
Yokayaki POS Roadmap
...
ตรรกะระบบจะคำนวณราคาโปรโมชันแบบ Fixed Price (บาทถ้วน) ที่บันทึกไว้ในตารางเมนู

      ...
      <div className="flex items-center gap-2">
        ...
        <div className="w-36">
          <CustomSelect
            ...
            searchable={false}
            triggerClassName="w-full bg-white dark:bg-neutral-900 border border-slate-300 dark:border-neutral-700 hover:bg-slate-50 dark:hover:bg-neutral-800 rounded-sm px-3 py-1.5 text-sm font-black text-slate-800 dark:text-neutral-100 shadow-2xs transition flex items-center justify-between cursor-pointer gap-1.5"
          />
        </div>

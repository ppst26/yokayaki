        ...
        <div className="flex items-center gap-3.5 self-end md:self-auto">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200/80 dark:border-amber-900/50 rounded-xl px-4 py-2 text-center">
            <span className="text-xl md:text-2xl font-black text-amber-600 dark:text-amber-400">
              ...
              <span className="text-xs font-bold text-amber-700 dark:text-amber-500">แต้ม</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2.5 bg-white dark:bg-neutral-900 hover:bg-slate-100 dark:hover:bg-neutral-800 border border-slate-200 dark:border-neutral-700 text-slate-700 dark:text-neutral-200 rounded-xl text-xs font-extrabold transition active:scale-95 shadow-2xs cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-xl text-xs font-extrabold transition active:scale-95 shadow-md shadow-red-600/20 cursor-pointer"
            >

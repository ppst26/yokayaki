    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-neutral-900 border border-slate-200/80 dark:border-neutral-800 p-5 rounded-2xl shadow-sm">
        <div>
          ...
          <p className="text-slate-500 dark:text-neutral-400 text-xs font-medium mt-0.5">เพิ่ม แก้ไข หรือลบรายการอาหารในระบบ POS</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-full md:w-60">
            ...
            <input
              ...
              className="w-full bg-slate-50 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 rounded-xl pl-9 pr-4 py-2 text-xs text-slate-800 dark:text-neutral-100 placeholder-slate-400 dark:placeholder-neutral-500 focus:outline-none focus:border-red-500 font-semibold"
            />
          </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition cursor-pointer border ${
              filterCategory === cat
                ...
                : 'bg-white dark:bg-neutral-800/90 border-slate-200 dark:border-neutral-700 text-slate-600 dark:text-neutral-300 hover:bg-slate-50 dark:hover:bg-neutral-700'
            }`}
          >
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-neutral-800 text-xs">
                {paginatedItems.map(item => (
                  <tr key={item.id} className="hover:bg-slate-50/80 dark:hover:bg-neutral-800/50 transition-colors">
                    <td className="py-3.5 px-6 font-bold text-slate-900 dark:text-neutral-100">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 overflow-hidden shrink-0 flex items-center justify-center">
                          {item.image_url ? (
                            <img
                              src={item.image_url}
                              alt={item.name}
                            ...
                            <UtensilsCrossed className="w-4 h-4 text-slate-400 dark:text-neutral-500 stroke-[1.5]" />
                          )}
                        </div>
                        <div>
                          <div>{item.name}</div>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      ...
                      <span className="text-slate-400 dark:text-neutral-500 text-xs ml-0.5 font-semibold">฿</span>
                    </td>
                    <td className="py-3.5 px-4 text-center">
                      <span className="text-[11px] font-bold px-2.5 py-1 bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 text-slate-600 dark:text-neutral-300 rounded-lg">
                        {item.category || '-'}
                      </span>
                    </td>
                    <td className="py-3.5 px-4 text-center">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          ...
                          className="focus:outline-none cursor-pointer p-1 rounded-md hover:bg-slate-100 dark:hover:bg-neutral-800 transition"
                        ...
                        >
                          {item.is_stock_tracked ? (
                            ...
                            <div className="flex items-center gap-1 text-[11px] font-bold text-slate-500 dark:text-neutral-400 bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 px-2 py-0.5 rounded-md">
                        ...
                        {item.is_stock_tracked && (
                          <div className="flex items-center gap-1 ml-1">
                            <button
                              ...
                              className="p-1 bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 rounded-md hover:bg-slate-200 dark:hover:bg-neutral-700 text-slate-700 dark:text-neutral-300 transition active:scale-90 cursor-pointer"
                            >
                            ...
                            <input
                              ...
                              className={`w-12 text-center py-0.5 bg-slate-50 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 rounded text-xs font-bold focus:outline-none focus:border-red-500 ${item.stock <= 3 ? 'text-rose-600 dark:text-rose-400' : 'text-slate-900 dark:text-neutral-100'}`}
                            />
                            <button
                              onClick={() => handleInlineStockUpdate(item.id, item.stock + 1)}
                              className="p-1 bg-slate-100 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 rounded-md hover:bg-slate-200 dark:hover:bg-neutral-700 text-slate-700 dark:text-neutral-300 transition active:scale-90 cursor-pointer"
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className="p-1.5 bg-white dark:bg-neutral-800 hover:bg-slate-100 dark:hover:bg-neutral-700 border border-slate-200 dark:border-neutral-700 rounded-lg text-slate-600 dark:text-neutral-300 hover:text-slate-900 dark:hover:text-neutral-100 transition active:scale-95 cursor-pointer shadow-xs"
                          title="แก้ไข"
                        >
                ...
                {filteredItems.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-16 text-center">
                      <UtensilsCrossed className="w-10 h-10 text-slate-300 dark:text-neutral-600 mx-auto mb-3" />
                      <p className="text-slate-400 dark:text-neutral-500 font-medium text-xs">ไม่พบรายการเมนูที่ตรงกับคำค้นหา</p>
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="w-full max-w-md bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-3xl p-6 shadow-xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-5 pb-3 border-b border-slate-100 dark:border-neutral-800">
              ...
              <button onClick={closeFormModal} className="p-1.5 bg-slate-100 dark:bg-neutral-800 hover:bg-slate-200 dark:hover:bg-neutral-700 text-slate-500 dark:text-neutral-400 rounded-full cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-4">
              {/* Name */}
              <div>
                <label className="block text-[11px] font-bold text-slate-500 dark:text-neutral-400 tracking-wider uppercase mb-1.5">ชื่อเมนู *</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div>
                ...
                />
                {formData.image_url ? (
                  <div className="mt-2.5 relative w-32 aspect-square rounded-xl overflow-hidden border border-slate-200 dark:border-neutral-700 bg-slate-100 dark:bg-neutral-800">
                    <img
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-neutral-500 mt-1 font-medium">ใส่ลิงก์รูปภาพอาหารสำหรับแสดงภาพในหน้า POS และ QR สั่งอาหาร</p>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-neutral-400 tracking-wider uppercase mb-1.5">ราคา (บาท) *</label>
                  <input
                    type="number"
                    min="0"
                    step="1"
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-neutral-400 tracking-wider uppercase mb-1.5">หมวดหมู่</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-3 items-end">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-neutral-400 tracking-wider uppercase mb-1.5">สต็อกเริ่มต้น</label>
                  <input
                    type="number"
                    min="0"
                    ...
                    className="w-full bg-slate-50 dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 focus:border-red-500 focus:outline-none rounded-xl px-4 py-2.5 text-xs font-semibold text-slate-800 dark:text-neutral-100 disabled:opacity-40 disabled:cursor-not-allowed"
                  />
                </div>
                <div>
                  <button
              ...
              <div className="flex gap-2 pt-3 border-t border-slate-100 dark:border-neutral-800">
                ...
                <button
                  ...
                  onClick={handleSave}
                  disabled={isSaving}
                  className="flex-1 py-2.5 bg-red-600 hover:bg-red-700 disabled:bg-slate-300 dark:disabled:bg-neutral-800 text-white text-xs font-extrabold rounded-xl transition active:scale-97 flex items-center justify-center gap-2 cursor-pointer shadow-sm shadow-red-600/20"
                >
                  {isSaving ? (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="w-full max-w-sm bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 rounded-3xl p-6 shadow-xl">
            <div className="text-center mb-5">
              ...
              <h3 className="text-base font-extrabold text-slate-900 dark:text-neutral-100 mb-1">ยืนยันการลบเมนู</h3>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 py-2.5 bg-rose-600 hover:bg-rose-700 disabled:bg-slate-300 dark:disabled:bg-neutral-800 text-white text-xs font-extrabold rounded-xl transition active:scale-97 flex items-center justify-center gap-2 cursor-pointer shadow-sm shadow-rose-600/20"
              >

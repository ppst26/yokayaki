      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-slate-50 dark:bg-neutral-800/90 border border-slate-200/80 dark:border-neutral-700/60 rounded-xl pl-4 pr-16 py-2.5 text-xl sm:text-2xl font-black text-slate-900 dark:text-neutral-100 text-right focus:outline-none focus:border-red-500 transition"
          />
          {cashNum > 0 && (
            <button
              type="button"
              onClick={() => setCashReceived('')}
              className="absolute left-3 top-1/2 -translate-y-1/2 px-2 py-1 bg-rose-50 dark:bg-rose-950/50 hover:bg-rose-100 dark:hover:bg-rose-900/60 rounded-lg text-xs font-bold text-rose-600 dark:text-rose-400 transition active:scale-95 cursor-pointer border-none"
              title="ล้างยอดเงินสด"
            >
              ล้าง
            </button>
        ...
        <div className="grid grid-cols-4 gap-1.5 sm:gap-2 mt-2">
          {[100, 500, 1000].map(amt => (
            <button
              ...
              className="w-full min-w-0 py-2 px-1 bg-slate-100 dark:bg-neutral-800 hover:bg-slate-200 dark:hover:bg-neutral-700 rounded-lg text-xs sm:text-sm font-bold text-slate-700 dark:text-neutral-200 transition active:scale-95 cursor-pointer border-none text-center truncate"
            >
              +{amt}
            </button>
          ))}
          <button
            ...
            className="w-full min-w-0 py-2 px-1 bg-emerald-50 dark:bg-emerald-950/40 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 rounded-lg text-xs sm:text-sm font-bold text-emerald-700 dark:text-emerald-300 transition active:scale-95 cursor-pointer border-none text-center truncate"
            title="ชำระเต็มจำนวน"
          >
            เต็มจำนวน
          </button>

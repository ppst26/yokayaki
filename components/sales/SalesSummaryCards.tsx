    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <Card className="p-5 space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-xs md:text-sm font-extrabold uppercase tracking-wider text-slate-400 dark:text-neutral-500">
            ยอดขายส่งมอบสุทธิ
          </span>
        ...
        <p className="text-2xl font-black text-slate-900 dark:text-neutral-100">
          {totalRevenue.toLocaleString()} <span className="text-sm font-bold text-slate-500 dark:text-neutral-400">฿</span>
        </p>
      </Card>
      ...
      <Card className="p-5 space-y-2">
        ...
        <p className="text-2xl font-black text-rose-600 dark:text-rose-400">
          -{totalDiscount.toLocaleString()} <span className="text-sm font-bold text-rose-500 dark:text-rose-400">฿</span>
        </p>
      </Card>
      ...
      <Card className="p-5 space-y-2">
        ...
        <p className="text-2xl font-black text-slate-900 dark:text-neutral-100">
          {totalBills} <span className="text-sm font-bold text-slate-500 dark:text-neutral-400">บิล</span>
        </p>
      </Card>
      ...
      <Card className="p-5 space-y-2">
        ...
        <p className="text-2xl font-black text-slate-700 dark:text-neutral-300">
          {totalVoidCount} <span className="text-sm font-bold text-slate-400 dark:text-neutral-500">รายการ ({totalVoidAmount.toLocaleString()} ฿)</span>
        </p>
      </Card>
    </div>
  );

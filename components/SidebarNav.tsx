...
export const SidebarNav: React.FC<SidebarNavProps> = ({ activeTab, onSelectTab }) => {
  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 z-30 bg-white dark:bg-neutral-900 border-b border-slate-200 dark:border-neutral-800 p-4 flex items-center justify-between shadow-xs">
